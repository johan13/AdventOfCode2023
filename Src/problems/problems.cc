...
namespace day13 { std::string part1(); std::string part2(); }
namespace day14 { std::string part1(); std::string part2(); }
namespace day15 { std::string part1(); std::string part2(); }
namespace day16 { std::string part1(); std::string part2(); }
namespace day17 { std::string part1(); std::string part2(); }
namespace day18 { std::string part1(); std::string part2(); }
namespace day19 { std::string part1(); std::string part2(); }
namespace day20 { std::string part1(); std::string part2(); }
namespace day21 { std::string part1(); std::string part2(); }
